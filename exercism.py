...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    ten_percent_threshold_low = threshold + 10 * threshold / 100

    if temp_neutrons < 90 * threshold / 100:
        return 'LOW'
    if ten_percent_threshold_low >= temp_neutrons and temp_neutrons <= ten_percent_threshold_low:
        return 'NORMAL'
    return 'DANGER'
